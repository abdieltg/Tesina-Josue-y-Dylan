...
if ($conexion->connect_error) {
    ...
    echo json_encode(['error' => 'Error de conexión', 'success' => false]);
    exit;
}
...
if ($conexion->query($sql)) {
    ...
    $sql_user = "UPDATE usuarios SET avatar_url = '$avatar_url_escaped' WHERE id = $usuario_id";
    $conexion->query($sql_user);
    ...
    http_response_code(500);
    echo json_encode(['error' => 'Error al guardar perfil', 'success' => false]);
}
